...
export const SAMPLE_SELFIES: SampleSelfie[] = [
  {
    id: '1',
    thumbUrl: 'https://plugins-media.makeupar.com/strapi/assets/thumbnail_general_01_f8f1fd2225.png',
    fullUrl: 'https://plugins-media.makeupar.com/strapi/assets/general_01_f8f1fd2225.png',
  },
  {
    id: '2',
    thumbUrl: 'https://plugins-media.makeupar.com/strapi/assets/thumbnail_general_02_2fe7709272.png',
    fullUrl: 'https://plugins-media.makeupar.com/strapi/assets/general_02_2fe7709272.png',
  },
  {
    id: '3',
    thumbUrl: 'https://plugins-media.makeupar.com/strapi/assets/thumbnail_general_03_61c348a4ab.png',
    fullUrl: 'https://plugins-media.makeupar.com/strapi/assets/general_03_61c348a4ab.png',
  },
  {
    id: '4',
    thumbUrl: 'https://plugins-media.makeupar.com/strapi/assets/thumbnail_general_04_e68f62b89d.png',
    fullUrl: 'https://plugins-media.makeupar.com/strapi/assets/general_04_e68f62b89d.png',
  },
  {
    id: '5',
    thumbUrl: 'https://plugins-media.makeupar.com/strapi/assets/thumbnail_general_05_63ad7f8c8e.png',
    fullUrl: 'https://plugins-media.makeupar.com/strapi/assets/general_05_63ad7f8c8e.png',
  },
  {
    id: '6',
    thumbUrl: 'https://plugins-media.makeupar.com/strapi/assets/thumbnail_general_06_40721739e8.png',
    fullUrl: 'https://plugins-media.makeupar.com/strapi/assets/general_06_40721739e8.png',
  },
]
...
export function stripEffectForApi(effect: MakeupEffect): MakeupEffect {
  ...
  if (rest.palettes) {
    rest.palettes = rest.palettes.filter((palette) => Boolean(palette.color?.trim()))
  }
  return rest
}
